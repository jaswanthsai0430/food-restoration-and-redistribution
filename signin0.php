...
<body>
    <div class="container">
        <form id="loginForm">
            <span class="title">Donor Login</span>
            <br><br>
            ...
            <div class="login-signup">
                <span class="text">Not a member?
                    <a href="signup0.php" class="text login-link">Signup</a>
                </span>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (email === "batchno.4@gmail.com" && password === "bhuvi") {
                window.location.href = "donatefood.php";  // Redirect to admin page if successful
            } else {
                errorMessage.style.display = 'block';
